const username = "MongoNotifications"; //process.env.IMAGES_DB_ROOT_USERNAME;
const password = "MongoNotifications22$"; //process.env.IMAGES_DB_ROOT_PASSWORD;
const host = "mongodb-notifications";
