  ...
  <main>
    ...
    >
      <div class="container text-center text-md-left" data-aos="fade-up">
        <h1>Welcome to <span>Smartdrive</span></h1>
        <h2>Improve your driving smartness with us.</h2>
    ...
    <main>
      ...
      <section id="about" class="about">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <!--src="/src/assets/style/img/roadHomePage.jpg"-->
              <img src="/src/assets/style/img/drivingHomePage.jpg" class="img-fluid" alt="" />
            </div>
    ...
    <footer id="footer">
      ...
      <div class="container d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Lumia</span></strong
            >. All Rights Reserved
          </div>
          <div class="credits">
...
#hero {
  width: 100%;
  height: 60vh;
  background: url("/src/assets/style/img/highwayHomePage.jpg") center center;
